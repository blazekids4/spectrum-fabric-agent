...
def main():
    ...
    try:
        ...
        print("\n📋 Example 1")
        response = client.ask("Tally the number of mentions by competitor across all customer calls")
        print(f"💬 Response: {response}")
        
        # Example 2: Another simple query
        print("\n📋 Example 2: ")
        response = client.ask("How many customers cancelled their service? What percentage of total calls?")
        print(f"💬 Response: {response}")
        ...
        run_details = client.get_run_details("Show me the top 5 records from the customer calls data")
